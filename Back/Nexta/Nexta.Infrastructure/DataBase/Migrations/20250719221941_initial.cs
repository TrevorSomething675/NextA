    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDetails", x => new { x.UserId, x.DetailId });
                    table.ForeignKey(
                        name: "FK_UserDetails_Details_DetailId",
                        column: x => x.DetailId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDetails", x => new { x.OrderId, x.DetailId });
                    table.ForeignKey(
