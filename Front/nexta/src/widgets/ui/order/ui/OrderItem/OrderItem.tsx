...
const OrderItemL:React.FC<{order:Order}> = ({order}) => {
        ...
        <table className={styles.table}>
            ...
            <tbody>
                {order.products !== undefined && order?.products?.map((orderProduct) => 
                    <tr className={styles.tr} key={orderProduct.product.id}>
                        <td>
                        ...
                        <td>
                            <span className={styles.newPrice}>
                                {orderProduct.product.newPrice * orderProduct.product.count} руб.
                            </span>
                            {(orderProduct.product.oldPrice !== undefined && orderProduct.product.oldPrice != 0) &&
                                <span className={styles.oldPrice}>
                                    {orderProduct.product.oldPrice * orderProduct.product.count} руб.
                                </span>
                            }
                        </td>
                        <td>
